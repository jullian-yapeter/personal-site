  ...
  >
    <article className="post" id="index">
      ...
      <p> Thanks for stopping by. Please feel free to read more <Link to="/about">about me</Link>,
        ...
        or <Link to="/contact">contact</Link> me. I am currently looking for a full-time role in
        the field of machine learning/robotics/software engineering. Whether you are hiring, or if
